...
export function Footer() {
  return (
    <footer className="bg-[#050914] border-t border-blue-900/20 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link to="/map" className="hover:text-amber-400">Crypto Map</Link></li>
              <li><Link to="/marketplace" className="hover:text-amber-400">Marketplace</Link></li>
              <li><Link to="/freelance" className="hover:text-amber-400">Freelance</Link></li>
              <li><Link to="/travel" className="hover:text-amber-400">Travel</Link></li>
            </ul>
          </div>
