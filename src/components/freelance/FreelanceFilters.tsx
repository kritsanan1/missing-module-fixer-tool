...
export function FreelanceFilters({ filters, onFilterChange, activeTab }: FiltersProps) {
      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          ...
          <RadioGroup
            ...
            className="space-y-2"
          >
            {(activeTab === "freelancers" ? freelancerCategories : jobCategories).map((category) => (
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-medium">
              {activeTab === "freelancers" ? "Hourly Rate (USD)" : "Budget Range (USD)"}
            </h3>
            ...
            <Slider
              ...
              min={0}
              max={activeTab === "freelancers" ? 500 : 10000}
              step={activeTab === "freelancers" ? 10 : 500}
